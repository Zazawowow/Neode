...
export const mockPatchData: DataModel = {
  ...
  'package-data': {
    ...
    atob: {
      state: PackageState.Installed,
      'static-files': {
        license: '/public/package-data/atob/0.1/LICENSE.md',
        icon: '/assets/img/atob.png',
        instructions: '/public/package-data/atob/0.1/INSTRUCTIONS.md',
      },
      manifest: {
        id: 'atob',
        title: 'A to B',
        version: '0.1',
        description: {
          short: 'A to B Bitcoin tools',
          long: 'Launches the A to B Bitcoin app in a new tab.',
        },
        'release-notes': 'Initial mock integration',
        assets: {
          icon: 'icon.png',
          license: 'LICENSE.md',
          instructions: 'INSTRUCTIONS.md',
        ...
        license: 'MIT',
        'wrapper-repo': 'https://example.com/atob-wrapper',
        'upstream-repo': 'https://app.atobitcoin.io',
        'support-site': 'https://app.atobitcoin.io',
        'marketing-site': 'https://app.atobitcoin.io',
        'donation-url': null,
        alerts: {
          install: null,
          uninstall: null,
        ...
        'health-checks': {},
        config: { get: null, set: null },
        volumes: {},
        'min-os-version': '0.2.12',
        interfaces: {
          ui: {
            name: 'Web UI',
            description: 'Open A to B in a new tab',
            ui: true,
            'tor-config': { 'port-mapping': {} },
            'lan-config': {},
            protocols: [],
          },
        },
        backup: { create: null as any, restore: null as any },
        migrations: null,
        actions: {},
        dependencies: {},
      },
      installed: {
        manifest: {
          ...
          'release-notes': '',
          assets: { icon: '', license: '', instructions: '', docker_images: '', assets: '', scripts: '' },
          license: '',
          'wrapper-repo': '',
          'upstream-repo': '',
          'support-site': '',
          'marketing-site': '',
          'donation-url': null,
          alerts: { install: null, uninstall: null, restore: null, start: null, stop: null },
          main: {
            type: 'docker', image: '', system: true, entrypoint: '', args: [], mounts: {}, 'io-format': DockerIoFormat.Yaml, inject: false, 'shm-size': '', 'sigterm-timeout': '0.5s',
          },
          'health-checks': {},
          config: { get: null, set: null },
          volumes: {},
          'min-os-version': '0.2.12',
          interfaces: { ui: { name: '', description: '', ui: true, 'tor-config': { 'port-mapping': {} }, 'lan-config': {}, protocols: [] } },
          backup: { create: null as any, restore: null as any },
          migrations: null,
          actions: {},
          dependencies: {},
        ...
        'interface-addresses': {
          ui: {
            'tor-address': 'app.atobitcoin.io',
            'lan-address': 'app.atobitcoin.io',
          },
        },
        'system-pointers': [],
        'current-dependents': {},
